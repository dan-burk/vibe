...
你想要编写代码，但记事本或文本编辑器功能有限。你需要一个能帮助你更快编码的工具——具有语法高亮、自动完成和内置工具。**VS Code 就像一个智能的代码笔记本**——它能理解你正在编写的内容并在过程中提供帮助。[Visual Studio Code](https://code.visualstudio.com) 是免费的，可在任何操作系统上运行，并被数百万开发者使用。

## 核心概念

- **Editor（编辑器）** - 你编写代码的主要区域
...
查看 Explorer——`notes` 文件夹出现了！终端在你的项目文件夹中运行，因此命令会直接影响你的项目。
...
- 点击 **File** → **Open Recent** → 选择你的文件夹
- 或点击 **File** → **Open Folder** 并导航到它

## 故障排除

- **预览未显示：** 确保已安装 Markdown Preview Enhanced extension，并且你打开了 `.md` 文件
...
- **探索 AI 功能：** 让 AI 编写代码、修复错误或为你的项目提供改进建议
- **安装更多 extensions：** 尝试"Prettier"进行自动格式化，或"GitLens"获取 Git 功能
- **学习快捷键：** 点击 **Help** → **Keyboard Shortcuts Reference** 加快你的工作流程
