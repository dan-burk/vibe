...
你正在做一个项目，结果改动了一些东西把一切都搞坏了。你不记得自己改了什么，真希望能回到代码还能用的时候。版本控制就像电子游戏中的存档点——每次你"提交"工作时，就创建了一个可以随时返回的还原点。[GitHub](https://github.com) 将你的存档点保存在云端，这样你的代码就被安全备份，可以从任何电脑访问。

## 核心概念

- **Git** - 版本控制软件，在你的电脑上跟踪文件的变更
- **GitHub** - 在云端存储代码的网站，就像代码的 Google Drive
- **GitHub Desktop** - 让 Git 变得简单易用的应用程序，用按钮操作而不是命令
...
- 保持名称不变
- 如果你想让其他人看到，取消勾选"Keep this code private"（可选）
- 点击 **Publish Repository**

你的代码现在已经在线备份到：`https://github.com/YOUR-USERNAME/my-first-project`
...
- **无法登录 GitHub** - 检查你的互联网连接。先尝试在 github.com 登录以验证你的凭据是否有效。
- **变更没有出现在 GitHub Desktop 中** - 确保你已保存文件。点击 **Repository** → **Refresh** 或重启 GitHub Desktop。
